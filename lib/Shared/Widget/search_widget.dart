...
class Search_widget extends StatefulWidget {
  ...
  void Function(String)? onChanged;
   Search_widget(this.controller,{super.key,this.onChanged});
      ...
      child: TextFormField(
       minLines: 1,
        ...
        decoration: InputDecoration(
            ...
            label: Text('بحث',style: TextStyle(fontSize: 20,color: Colors.green),),
            border: OutlineInputBorder(

                borderRadius: BorderRadius.circular(15),
                borderSide: BorderSide(style: BorderStyle.solid,width: 1.0,color: Colors.green,),
            )
        ),
      ),
    );
